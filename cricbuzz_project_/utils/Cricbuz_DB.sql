...
SELECT * FROM  fielding_scorecard;
...
SELECT * FROM  venues;
SELECT * FROM  teams;
SELECT * FROM trending_players;
SELECT * FROM  players_full_stats;
SELECT * FROM player_master_stats;
SELECT * FROM player_rankings_history;
...
win_by_runs, win_by_wickets, venue_name  FROM matches 
...
GROUP BY b.player_name,b.team_name
HAVING COUNT(*)>=1   -- was 10, relaxed so rows appear
